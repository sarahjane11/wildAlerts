...
<p>Dear <?php echo ucwords($name); ?></p>
    ...
    <?php
        $appLink=base64_encode("uersVarification://com.talentelgia.WildAlerts?code=".$keystring);  
  ...
  <p>To verify your account form IOS APP  <a  class="btn" style="color:#fff; background:#164C9A; padding:4px 6px;  text-decoration:none; font-size:15px; line-height: 20px; border-radius:3px;"  href="<?php echo Yii::app()->request->hostInfo.Yii::app()->request->baseUrl; ?>/site/openapp?link=<?php echo $appLink;  ?>"> Confirm</a> </p>
