...
<!--                <p>For mobile app. </p>
                ...
                <p> To reset  your password from IOS APP <a  class="btn" style="color:#fff; background:#164C9A; padding:4px 6px;  text-decoration:none; font-size:15px; border-radius:3px;"  href="<?php echo Yii::app()->request->hostInfo.Yii::app()->request->baseUrl; ?>/site/openapp?link=<?php echo $appLink;  ?>" > Click Here</a></p>

                <p> To reset  your password from web <a href="<?php echo Yii::app()->request->hostInfo.Yii::app()->request->baseUrl; ?>/site/ResetPassword?token=<?php echo $appLink;  ?>">Click Here </a> </p> 
