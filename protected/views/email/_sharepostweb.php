...
<p>Dear user </p>
     ...
     <?php
        //$appLink=base64_encode("uersVarification://com.talentelgia.WildAlerts?code=".$sharelink);  
         
        ?>
 

<p> Your friend has shared a post with you.  Click on below link to see the post on web.</p>
<p><a href="<?php echo $sharelink ;  ?>">Click here </a> </p> 
