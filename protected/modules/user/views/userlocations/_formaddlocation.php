...
<!--    <label>Address</label>
    <input id="search" name="addaddress" value=""/>
   

    <button class="btn btn-primary latlang" id="lt" >Click here for set address on map</button>-->
</div>
...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
		...
		<?php echo $form->labelEx($model,'location_type'); ?></div>
	...
	<div class="form-group">
                            <div class="col-xs-12 col-md-3 col-sm-3">
		<?php echo $form->labelEx($model,'Description'); ?></div>
		<div class="col-xs-12 col-md-9 col-sm-9"><?php echo $form->textField($model,'description',array('size'=>60,'maxlength'=>255)); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'alert_notification', array('1' => 'Activated', '0' => 'Deactivated')); ?>
		<?php echo $form->error($model,'alert_notification'); ?>
	

	
            
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Add location' : 'Save'); ?>
...
// pick list containing a mix of places and predicted search terms.
        ...
        function initAutocomplete() {
          var map = new google.maps.Map(document.getElementById('googleMap'), {
            center: {lat: 30.7500, lng: 76.7800},
            zoom: 13,
